...
:- export((setup/3, setup/4, setup/5, setup/6,
	   ...
	   implies/2, implies/3, contradiction/2, conflicting_roles/2,
	   subrole/2, conflicting_roles/1, conflicting_roles/2,
	   roles_relation/1, generalization/2,
	   symmetric/1, antisymmetric/1, antireflexive/1,
	   left_unique/1, right_unique/1,
	   unique_role/1,
	   transitive/1, transitive_closure/2,
	   need/1, object/1, location/1,
	   role_need/2, role_object/2, role_location/2)).

:- dynamic implies/2, implies/3.
:- dynamic subrole/2, conflicting_roles/1, conflicting_roles/2.
:- dynamic roles_relation/1, generalization/2.
:- dynamic symmetric/1, antisymmetric/1, antireflexive/1,
   left_unique/1, right_unique/1,
   unique_role/1.
:- dynamic transitive/1, transitive_closure/2.
:- dynamic need/1, object/1, location/1.
:- dynamic role_need/2, role_object/2, role_location/2.

:- discontiguous implies/2, implies/3, relation/1, contradiction/2.
:- discontiguous subrole/2, conflicting_roles/1, conflicting_roles/2.
:- discontiguous roles_relation/1, generalization/2.
:- discontiguous symmetric/1, antisymmetric/1, antireflexive/1,
   left_unique/1, right_unique/1,
   unique_role/1.
:- discontiguous transitive/1, transitive_closure/2.
:- discontiguous need/1, object/1, location/1.
:- discontiguous role_need/2, role_object/2, role_location/2.

:- multifile implies/2, implies/3, relation/1, contradiction/2.
:- multifile subrole/2, conflicting_roles/1, conflicting_roles/2.
:- multifile roles_relation/1, generalization/2.
:- multifile symmetric/1, antisymmetric/1, antireflexive/1,
   left_unique/1, right_unique/1,
   unique_role/1.
:- multifile transitive/1, transitive_closure/2.
:- multifile need/1, object/1, location/1.
:- multifile role_need/2, role_object/2, role_location/2.
